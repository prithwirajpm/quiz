...
function Introduction() {
    ...
    return (
        <div style={{ width: '100%' }} className='intoBox'>
            {
                showTitle? <div className='bgc'>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '20px' }}><button onClick={()=>setshowTitle(false)} style={{ border: 'none', borderRadius: '10px', padding: '10px', backgroundColor: '#e7e7e7' }}>Start Game</button></div>
